...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <div className="fixed top-0 left-0 h-full w-64 bg-white text-white flex flex-col p-4">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <Link
            to="/chapters"
            className={`flex items-center space-x-4 p-2 rounded-md cursor-pointer text-black ${
              isActive("/chapters") ? "bg-gray-200" : "hover:bg-gray-100"
            }`}
          >
          ...
          <Link
            to="/help"
            className={`flex items-center space-x-4 p-2 rounded-md cursor-pointer text-black ${
              isActive("/help") ? "bg-gray-200" : "hover:bg-gray-100"
            }`}
          >
            <TbHelp size={24} />
          ...
          <Link
            to="/reports"
            className={`flex items-center space-x-4 p-2 rounded-md cursor-pointer text-black ${
              isActive("/reports") ? "bg-gray-200" : "hover:bg-gray-100"
            }`}
          >
